...
do *not* change in a perfectly elastic collision.
...
velocity that change due to collision.
...
* how tangent vectors work in 3D,
* why perpendicular vectors are used,
* or show a short C program that prints normal/tangent axes.
